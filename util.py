...
# target = cv2.imread("C:\\Users\\marcj\\Desktop\\Github Projects\\MinecraftCV\\target_code_side.png")
# img = cv2.imread("target_images\\portfolio.png")
# confirm_portfolio(img)
#template_helper(img, target)